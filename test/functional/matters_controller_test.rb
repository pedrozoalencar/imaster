...
class MattersControllerTest < ActionController::TestCase
  ...
  test "should create matter" do
    assert_difference('Matter.count') do
      post :create, matter: { matter_father_id: @matter.matter_father_id, name: @matter.name, workflow_state: @matter.workflow_state }
    end
  ...
  test "should update matter" do
    put :update, id: @matter, matter: { matter_father_id: @matter.matter_father_id, name: @matter.name, workflow_state: @matter.workflow_state }
    assert_redirected_to matter_path(assigns(:matter))
  end
